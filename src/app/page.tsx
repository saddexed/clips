  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <header style={{ position: 'sticky', top: 0, left: 0, right: 0, zIndex: 10, width: '100%', background: 'var(--glass)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', borderBottom: '1px solid var(--glass-border)' }}>
        <div style={{ width: '100%', maxWidth: '1200px', margin: '0 auto', padding: '1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      ...
      <main className="page-container" style={{ flex: 1 }}>
        <div style={{ padding: '1rem 0 3rem', display: 'flex', flexDirection: 'column', alignItems: 'stretch', width: '100%' }}>
          <p style={{ color: 'var(--muted-foreground)', fontSize: '1.125rem', maxWidth: '600px', lineHeight: 1.6, margin: '0 auto', textAlign: 'center' }}>
